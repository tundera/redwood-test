...
const Header = () => {
  ...
  return (
    <header className="sticky top-0 z-10 w-full bg-black backdrop-blur-sm saturate-150">
      <nav className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8" aria-label="Top">
        <div className="flex items-center justify-between w-full border-b border-indigo-500 lg:border-none">
          <div className="flex items-center">
            <Link to={routes.home()}>
              <span className="sr-only">Home</span>
              <svg
                viewBox="0 0 567 640"
                className="w-auto h-20 text-white fill-current dark:text-black"
              >
